...
bool Ipv4Address::isPrivate() const {
  return
    // 10.0.0.0/8
    (value & 0xff000000) == ((unsigned int)10 << (unsigned int)24) ||
    // 172.16.0.0/12
    (value & 0xfff00000) == (((unsigned int)172 << (unsigned int)24) | ((unsigned int)16 << (unsigned int)16)) ||
    // 192.168.0.0/16
    (value & 0xffff0000) == (((unsigned int)192 << (unsigned int)24) | ((unsigned int)168 << (unsigned int)16));
}
